...
abstract contract AutomateTaskCreator is BaseScript {
    IAutomate internal automate;

    constructor(address _automate) BaseScript(_automate) {
    ...
    function _eventTriggerModuleArg(address _address, bytes32[][] memory _topics, uint256 _blockConfirmations)
        internal
        pure
        returns (bytes memory)
    {
